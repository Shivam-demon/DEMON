...
from Demon import pbot as app 
from Demon import arq
from Demon.services.keyboard import Ikb
from Demon.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from Demon.services.tasks import _get_tasks_text, all_tasks, rm_task
from Demon.services.types import InlineQueryResultCachedDocument
from Demon.modules.info import get_chat_info, get_user_info
from Demon.modules.music import download_youtube_audio
from Demon.utils.functions import test_speedtest
from Demon.utils.pastebin import paste
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/shivamdemon)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
